...
def main():
    ...
    wiki_df = spark.read.schema(schema).json("/Users/sangho/k-culturefy-project/extracted_text/*/*")
    ...
    def save_to_chromadb(iterator):
        import chromadb
        db_client = chromadb.PersistentClient(path="/Users/sangho/k-culturefy-project/korea_db")
